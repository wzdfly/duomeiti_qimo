      ...
      if (this.image !== undefined) {
         if (!this.image.complete) {
            this.image.onload = function (e) {
               ...
               // sprite.height = this.height; // 否则初始化赋的width, height值可能失效，而显示为图像尺寸
...
SpriteSheetPainter = function (cells, spritesheet) { //added by zjvivi，否则必须命名全局变量spritesheet
   this.cells = cells;
   this.spritesheet = spritesheet; //added by zjvivi
};
